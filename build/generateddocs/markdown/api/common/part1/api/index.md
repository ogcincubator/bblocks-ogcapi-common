...
The landing page ([`/`](bblocks://ogc.api.common.part1.paths.LandingPage)) and conformance
declaration ([`/conformance`](bblocks://ogc.api.common.part1.paths.Conformance)) operations are
reused from their own building blocks; only the `/api` (API definition) operation is declared
